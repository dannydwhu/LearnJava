...
public class Base62Utils {
    ...
    public static String encode_bi(BigInteger bi) {
        String str = "";
        String strVal = bi.toString(10);
        int midlen = strVal.length();
        int segments = midlen / encodeBlockSize;
        int start = midlen;
        for (int i = 0; i < segments; i++) {
    ...
    public static BigInteger decode_bi(String str) {
        String num = "";
        int strlen = str.length();
        int segments = strlen / decodeBlockSize;
        int start = strlen;
...
//        System.out.println(decode_bi(encode_bi(new BigInteger("12345671024"))));
        System.out.println(Long.toBinaryString(Long.valueOf(decode_bi("9Avn2A4anP")+"")));
    }
